...
API_BASE_URL = os.getenv("API_BASE_URL", "http://localhost:5000/api/v1/livro")
...
def inserir_livro():
    ...
    payload = {"nome": nome, "autor": autor, "genero": genero}
...
def atualizar_livro(livro_id):
    ...
    payload = {"id": livro_id, "nome": nome, "autor": autor, "genero": genero}
